...
const Sidebar = () => {
  ...
  return !isMenuOpen ? (
    <div className="fixed h-[95vh] w-20 bg-white px-1 py-4 text-[10px] text-slate-700 ">
      <div className="">
        <ul className="flex flex-col gap-5">
          <li className="flex w-full flex-col items-center justify-center gap-2 rounded-lg px-2 py-2 hover:cursor-pointer hover:bg-slate-200">
            <FontAwesomeIcon icon={faHouse} className="size-5 text-black" />
            Home
          </li>
          <li className="flex w-full flex-col items-center justify-center gap-2 rounded-lg px-2 py-2 hover:cursor-pointer hover:bg-slate-200">
    ...
    <div className="fixed flex h-[95vh] w-60 flex-col flex-nowrap gap-5 overflow-y-hidden bg-white px-3 py-2 text-base text-slate-700 hover:overflow-y-scroll">
      <div className="">
        <ul>
      ...
      <div className="">
        ...
        <ul>
          ...
          <li className="flex w-full items-center gap-5 rounded-lg px-2 py-2 hover:cursor-pointer hover:bg-slate-200">
            <FontAwesomeIcon icon={faThumbsUp} className="size-6 text-black" />
            Liked Videos
          </li>
        </ul>
      </div>
      ...
      <div className="">
        ...
        <ul>
          ...
          <li className="flex w-full items-center gap-5 rounded-lg px-2 py-2 hover:cursor-pointer hover:bg-slate-200">
            <FontAwesomeIcon icon={faNewspaper} className="size-6 text-black" />
            News
          </li>
          <li className="flex w-full items-center gap-5 rounded-lg px-2 py-2 hover:cursor-pointer hover:bg-slate-200">
          ...
          <li className="flex w-full items-center gap-5 rounded-lg px-2 py-2 hover:cursor-pointer hover:bg-slate-200">
            <FontAwesomeIcon icon={faLightbulb} className="size-6 text-black" />
            Courses
          </li>
          <li className="flex w-full items-center gap-5 rounded-lg px-2 py-2 hover:cursor-pointer hover:bg-slate-200">
